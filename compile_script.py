...
files_to_compile = ['poten', 'lib\hd44780']
file_to_compile = 'poten'
if len(sys.argv) == 2:
    com_port = 'com4'
else:
	com_port = sys.argv[2]
...
# path_win_avr = 'mnt/c/avr-gcc-11.1.0-x64-windows/bin/'
# path_win_avr = '/mnt/c/Users/nlam1/Documents/avr-gcc-11.1.0-x64-windows/bin/'
path_win_avr = 'c:\\Users\\nlam1\\Documents\\avr-gcc-11.1.0-x64-windows\\bin\\'
